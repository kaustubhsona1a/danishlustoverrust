  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center text-zinc-300 font-sans">
        <Car className="w-12 h-12 text-[#00C0FF] mb-4" />
        <h1 className="text-xl font-serif text-white tracking-widest uppercase mb-4">Unauthorized Access</h1>
        <p className="text-zinc-500 mb-8 max-w-sm text-center">You must be logged in as an administrator to view this portal.</p>
        <Link to="/dealer-login" className="bg-[#00C0FF] text-zinc-950 px-8 py-3 uppercase tracking-widest text-xs font-bold hover:bg-white transition-colors">
          Return to Login
        </Link>
      </div>
    );
      ...
      <div className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col">
        <div className="p-6 border-b border-zinc-800">
          <Link to="/" className="flex flex-col items-start group">
            <span className="font-serif text-2xl tracking-wider text-white font-bold leading-none uppercase">LUST OVER</span>
            <span className="font-sans text-[0.65rem] tracking-[0.35em] text-[#00C0FF] font-medium leading-tight uppercase font-mono">RUST</span>
          </Link>
        ...
        <nav className="flex-1 py-8 px-4 space-y-2">
          <Link to="/dealer" className="flex items-center px-4 py-3 text-zinc-400 hover:bg-zinc-800 hover:text-white transition-colors rounded-sm group">
            <LayoutDashboard className="w-4 h-4 mr-3 text-zinc-500 group-hover:text-[#00C0FF]" />
          ...
          <Link to="/dealer/inventory" className="flex items-center px-4 py-3 text-zinc-400 hover:bg-zinc-800 hover:text-white transition-colors rounded-sm group">
            <Car className="w-4 h-4 mr-3 text-zinc-500 group-hover:text-[#00C0FF]" />
        ...
        <div className="p-4 border-t border-zinc-800">
          <button onClick={handleLogout} className="flex items-center w-full px-4 py-3 text-zinc-400 hover:bg-zinc-800 hover:text-white transition-colors rounded-sm group">
            <LogOut className="w-4 h-4 mr-3 text-zinc-500 group-hover:text-[#00C0FF]" />
