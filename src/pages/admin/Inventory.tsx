                ...
                <tr key={car.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end space-x-2">
                      <Link to={`/dealer-management/inventory/edit/${car.id}`} className="p-2 text-zinc-400 hover:text-[#00C0FF] bg-zinc-900/30 hover:bg-white/5 border border-white/5 hover:border-[#00C0FF]/30 rounded-xl transition-all">
